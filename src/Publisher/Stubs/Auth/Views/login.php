...
<?= $this->section('main') ?>
    ...
    <form action="<?= url_to('login') ?>" method="post">
        ...
        <?php if (setting('Auth.allowRegistration')) : ?>
            <p class="mt-4 text-center text-sm text-gray-600"><?= lang('Auth.needAccount') ?> <a href="<?= url_to('register') ?>" class="font-medium text-indigo-600 hover:text-indigo-500"><?= lang('Auth.register') ?></a></p>
        <?php endif ?>
