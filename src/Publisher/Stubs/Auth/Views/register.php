...
<?= $this->section('main') ?>
    ...
    <form action="<?= url_to('register') ?>" method="post">
        ...
        <p class="mt-4 text-center text-sm text-gray-600"><?= lang('Auth.alreadyHaveAccount') ?> <a href="<?= url_to('login') ?>" class="font-medium text-indigo-600 hover:text-indigo-500"><?= lang('Auth.login') ?></a></p>
